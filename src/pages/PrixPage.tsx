...
import { ArrowRight, ChevronDown, ChevronLeft, ChevronRight, Headphones, Phone, Play, ShieldCheck, Sparkles, Users } from "lucide-react";
import "./prix.css";
...
export default function PrixPage() {
  ...
  return <div className="lp-page"><main>
    <section className="lp-video-first" id="presentation"><img className="lp-first-logo" src={logo} alt="Zaki Cleaning Service" /><div className="lp-video-placeholder"><div className="lp-play"><Play size={24} fill="currentColor" /></div><p>Votre vidéo de présentation</p><span>Elle sera ajoutée ici prochainement</span></div><div className="lp-video-context"><p className="lp-eyebrow lp-blue">Nettoyage professionnel à Alger</p><h1>La propreté qui se voit.<br /><em>La confiance qui reste.</em></h1><p>Une équipe sérieuse, un travail soigné et une vraie attention portée à chaque détail de votre espace.</p></div></section>
